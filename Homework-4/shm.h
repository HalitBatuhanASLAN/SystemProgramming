 ...
 * eof_count_per_level[i] reaches total_readers once every Reader has
 * pushed an EOF marker for level i.
 * ============================================================================= */
typedef struct
{
 ...
 * The Dispatcher pushes entries whose source is in the priority filter
 * list; a thread inside the Aggregator drains them.
 * ============================================================================= */
typedef struct
{
