...
\begin{tabular}{rl}
\textbf{Student Name:} & \texttt{[Halit Surname]} \\[6pt]
\textbf{Student ID:}   & \texttt{[XXXXXXXXX]} \\[6pt]
\textbf{Course:}       & CSE 344 -- System Programming \\[6pt]
\textbf{Homework:}     & \#4 \\[6pt]
\textbf{Due Date:}     & 02 April 2026 \\[6pt]
\textbf{Platform:}     & Debian 12 (64-bit) on VirtualBox \\[6pt]
...
\begin{infobox}
Each subsection includes the exact command, the expected outcome, and
a placeholder for the uncut terminal screenshot. To complete the
report, replace each \code{\textbackslash{}includegraphics} placeholder
with your own screenshot taken on your VM.
\end{infobox}
...
%     \caption{Test~1 -- Baseline. Uncut terminal from prompt to exit.}
% \end{figure}

\noindent
\textit{[Screenshot to be inserted: \code{screenshots/test1\_baseline.png}.]}
...
\noindent
\textit{[Screenshot to be inserted: \code{screenshots/test2\_multikw.png}.]}
...
\noindent
\textit{[Screenshot to be inserted: \code{screenshots/test3\_single.png}.]}
...
\noindent
\textit{[Screenshot to be inserted: \code{screenshots/test4\_concurrency.png}.]}
...
\noindent
\textit{[Screenshot to be inserted: \code{screenshots/test5\_emptyfilter.png}.]}
...
\noindent
\textit{[Screenshot to be inserted: \code{screenshots/test6\_valgrind.png}.]}
...
\noindent
\textit{[Screenshot to be inserted: \code{screenshots/test7\_sigint.png}.]}
